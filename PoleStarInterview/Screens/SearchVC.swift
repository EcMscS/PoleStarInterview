...
class SearchVC: UIViewController {
    ...
    @objc func pushTwitterHandleSelectedVC() {
        guard isUsernameEntered else {
            presentCustomAlertOnMainThread(title: "Empty Twitter Handle", message: "Please enter someone's Twitter handle 🐦", buttonTitle: "OK")
            return
        }
    ...
    func configureActionButton() {
        ...
        callToActionButton.addTarget(self, action: #selector(pushTwitterHandleSelectedVC), for: .touchUpInside)
